...
public class Safespec_UK_Sanity {
	...
	public void Start() {
		...
		driver.get("https://www.safespec.dupont.co.uk/");
	}
	@Test(priority=0)
	...
	public void Nomex_Page(){
		...
		middle.get(0).click();
		if(driver.getCurrentUrl().contains("https://www.safespec.dupont.co.uk/products/nomex.html")){
			System.out.println("Pass");
		} else {
			System.out.println("Fail");
		}
	...
	public void Navigation_Logo(){
		...
		if(URL.contains("https://www.safespec.dupont.co.uk/")){
			System.out.println("Pass");
		} else{
			System.out.println("Fail");
		}
