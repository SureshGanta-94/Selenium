...
public class Safespec_DE_Sanity {
	...
	public void Start() {
		...
		driver.get("https://www.safespec.dupont.de/");
	}
	@Test(priority=0)
	...
	public void Search_Validation(){
		...
		if(driver.getPageSource().contains("Keine Suchergebnisse gefunden.")){
			System.out.println("Pass");
		} else {
			System.out.println("Fail");
		}
	...
	@Test(priority=4)
	public void Nomex_Page() throws InterruptedException{
		List<WebElement> FirstLevelMenu = driver.findElements(By.cssSelector(".dropdown.first-level"));
		Actions action = new Actions(driver);
		...
		middle.get(0).click();
		Thread.sleep(3000);
		if(driver.getCurrentUrl().contains("https://www.safespec.dupont.de/products/nomex.html")){
			System.out.println("Pass");
		} else {
			System.out.println("Fail");
		}
	...
	public void Language(){
		...
		if(language.getText().contains("EMEA")){
			System.out.println("Pass");
		} else {
			System.out.println("Fail");
		}
	...
	public void Navigation_Logo(){
		...
		if(URL.contains("https://www.safespec.dupont.de/")){
			System.out.println("Pass");
		} else{
			System.out.println("Fail");
		}
