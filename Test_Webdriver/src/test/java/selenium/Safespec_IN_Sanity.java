...
public class Safespec_IN_Sanity {
	...
	public void Start() {
		...
		driver.get("https://www.safespec.dupont.co.in/");
	}
	@Test(priority=0)
	...
	public void Kevlar_Page(){
		...
		middle.get(0).click();
		if(driver.getCurrentUrl().contains("https://www.safespec.dupont.co.in/products/kevlar.html")){
			System.out.println("Pass");
		} else {
			System.out.println("Fail");
		}
	...
	public void Language(){
		...
		if(language.getText().contains("INDIA")){
			System.out.println("Pass");
		} else {
			System.out.println("Fail");
		}
	...
	public void Navigation_Logo(){
		...
		if(URL.contains("https://www.safespec.dupont.co.in/")){
			System.out.println("Pass");
		} else{
			System.out.println("Fail");
		}
