...
public WebDriver driver = new ChromeDriver();
	...
	public void HeaderValues() throws IOException{
		...
		setCellData("UK",1,0,"Main URL");
		setCellData("UK",2,0,"Target URL");
		setCellData("UK",3,0,"Staus Code");
	}
	@Test(priority=1)
	public void CTA1() throws IOException {
		driver.manage().window().maximize();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		String Main_URL = "https://www.dupont.co.uk/";
		driver.get(Main_URL);
		...
		setCellData("UK",1,1,Main_URL);
		setCellData("UK",2,1,Target_URL);
		setCellData("UK",3,1,Status_Code);
	}
	@Test(priority=2)
	public void CTA2() throws IOException, InterruptedException {
		String Main_URL = "https://www.dupont.co.uk/now.html";
		driver.get(Main_URL);
		driver.findElement(By.cssSelector(".campaign-cta.video")).click();
		Thread.sleep(5000);
		String Target_URL = driver.getCurrentUrl();
		int S_Code = getHTTPResponseStatusCode(Target_URL);
		String Status_Code = String.valueOf(S_Code);
		setCellData("UK",0,2,"2");
		setCellData("UK",1,2,Main_URL);
		setCellData("UK",2,2,Target_URL);
		setCellData("UK",3,2,Status_Code);
	}
	@Test(priority=3)
	public void CTA3() throws IOException {
		String Main_URL = "https://www.dupont.co.uk/news.html";
		driver.get(Main_URL);
		WebElement element = driver.findElement(By.cssSelector(".heroImage-Text_Link.heroImage_Button.default"));
		...
		setCellData("UK",1,3,Main_URL);
		setCellData("UK",2,3,Target_URL);
		setCellData("UK",3,3,Status_Code);
	}
	@Test(priority=4)
	public void CTA4() throws IOException, InterruptedException {
		...
		setCellData("UK",1,4,Main_URL);
		setCellData("UK",2,4,Target_URL);
		setCellData("UK",3,4,Status_Code);
	}
	@Test(priority=5)
	public void CTA5() throws IOException, InterruptedException {
		...
		setCellData("UK",1,5,Main_URL);
		setCellData("UK",2,5,Target_URL);
		setCellData("UK",3,5,Status_Code);
	}
	@Test(priority=6)
	public void CTA6() throws IOException, InterruptedException {
		...
		setCellData("UK",1,6,Main_URL);
		setCellData("UK",2,6,Target_URL);
		setCellData("UK",3,6,Status_Code);
	}
	@Test(priority=7)
	public void CTA7() throws IOException, InterruptedException {
		...
		setCellData("UK",1,7,Main_URL);
		setCellData("UK",2,7,Target_URL);
		setCellData("UK",3,7,Status_Code);
	}
	@Test(priority=8)
	public void CTA8() throws IOException, InterruptedException {
		...
		setCellData("UK",1,8,Main_URL);
		setCellData("UK",2,8,Target_URL);
		setCellData("UK",3,8,Status_Code);
	}
	@AfterTest
