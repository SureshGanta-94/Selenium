...
public WebDriver driver = new ChromeDriver();
	...
	public void HeaderValues() throws IOException{
		...
		setCellData("CN",1,0,"Main URL");
		setCellData("CN",2,0,"Target URL");
		setCellData("CN",3,0,"Staus Code");
	}
	@Test(priority=1)
	public void CTA1() throws IOException, InterruptedException {
		driver.manage().window().maximize();
		String Main_URL = "https://www.dupont.cn/";
		driver.get(Main_URL);
		WebElement element = driver.findElement(By.cssSelector(".cta"));
		...
		setCellData("CN",1,1,Main_URL);
		setCellData("CN",2,1,Target_URL);
		setCellData("CN",3,1,Status_Code);
	}
	@Test(priority=2)
	public void CTA2() throws IOException, InterruptedException {
		...
		setCellData("CN",1,2,Main_URL);
		setCellData("CN",2,2,Target_URL);
		setCellData("CN",3,2,Status_Code);
	}
	@Test(priority=3)
	public void CTA3() throws IOException, InterruptedException {
		...
		setCellData("CN",1,3,Main_URL);
		setCellData("CN",2,3,Target_URL);
		setCellData("CN",3,3,Status_Code);
	}
	@Test(priority=4)
	public void CTA4() throws IOException, InterruptedException {
		String Main_URL = "https://www.dupont.cn/news.html";
		driver.get(Main_URL);
		WebElement element = driver.findElement(By.cssSelector(".cta"));
		JavascriptExecutor jse = (JavascriptExecutor)driver;
		jse.executeScript("arguments[0].click()", element);
		...
		setCellData("CN",1,4,Main_URL);
		setCellData("CN",2,4,Target_URL);
		setCellData("CN",3,4,Status_Code);
	}
	@Test(priority=5)
	public void CTA5() throws IOException, InterruptedException {
		String Main_URL = "https://www.dupont.cn/about.html";
		driver.get(Main_URL);
		WebElement element = driver.findElement(By.cssSelector(".h-cta"));
		JavascriptExecutor jse = (JavascriptExecutor)driver;
		jse.executeScript("arguments[0].click()", element);
		Thread.sleep(3000);
		String Target_URL = driver.getCurrentUrl();
		...
		setCellData("CN",1,5,Main_URL);
		setCellData("CN",2,5,Target_URL);
		setCellData("CN",3,5,Status_Code);
	}
